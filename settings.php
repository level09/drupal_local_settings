...
if(file_exists(DRUPAL_ROOT .'/sites/default/local_settings.php')){
    
    
    include(DRUPAL_ROOT .'/sites/default/local_settings.php');
}
 ...
 *
 */
$drupal_hash_salt = 'Rl3EVDjKjkUEagXfy83LaC575Mz13HrWZ1hyITBWFrM';
